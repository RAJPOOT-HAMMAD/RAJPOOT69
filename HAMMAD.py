# Decompiled By HAMMAD RAJPOOT
# Github : https://github.com/
# uncompyle6 version 1.1.3
# Original written HAMMAD RAJPOOT
 
import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass
__author__ = 'USMAN'
__copyright = 'All rights reserved . Copyright  HAMMAD RAJPOOT'
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
            ...
            time.sleep(1)
            os.system('xdg-open https://www.facebook.com/profile.php?id=100073809715864')
            os.system('clear')
            loop = 'false'
    else:
...
\x1b[1;96m\033[1;96mAuthor   :            HAMAD RAJPOOT
\x1b[1;96m\033[1;96mFacebook :          https://www.facebook.com/profile.php?id=100073809715864
\x1b[1;96m\033[1;96mGitHub   :        github.com/RAJPOOT-HAMMAD
\x1b[1;96m\033[1;96mVersion  :              0.1
\x1b[1;96m________________________________________________________
                                                 """
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m  [RAJPOOT_OK]  ' + k + c + user + '  |  ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;91m  [RAJPOOT_CP] ' + k + c + user + '  |  ' + pass2
                    cps = open('save/CP.txt', 'a')
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;91m  [RAJPOOT_CP] ' + k + c + user + '  |  ' + pass3
                        cps = open('save/CP.txt', 'a')
